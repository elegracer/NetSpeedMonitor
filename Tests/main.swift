...
expect(AppSettings.displayVersion(marketingVersion: "1.21", releaseTag: "v1.21-beta.1") == "1.21-beta.1", "about displays prerelease version")
expect(AppSettings.displayVersion(marketingVersion: "1.21", releaseTag: "v1.21") == "1.21", "about displays stable version")
expect(AppSettings.displayVersion(marketingVersion: "1.21", releaseTag: "v1.22-beta.1") == "1.21", "about rejects mismatched release tag")
expect(AppSettings.displayVersion(marketingVersion: "1.21", releaseTag: nil) == "1.21", "about falls back without release tag")
...
expect(AppSettings.compareVersions("v1.21-beta.2", "v1.21-beta.1") == .orderedDescending, "prerelease downgrade comparison")
